...
function Experience() {
    ...
    return(
        <section id='experience' className='py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[16vw] font-sans clip-path-custom-2' style={{
                            ...
                            <div className='mt-4'>
                                ...
                                <ul className='flex flex-wrap mt-2'>
                                    {experience.skills.map((skill, index) => (
                                        <li key={index} className='bg-blue-700 text-gray-300 px-4 py-1 text-xs sm:text-sm rounded-lg mr-2 mb-2 border border-gray-400'>
                                            {skill}
                                        </li>
                                    ))}
                                </ul>
