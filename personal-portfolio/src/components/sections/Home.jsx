            ...
            <RevealOnScroll>
                <div className="text-center z-10 px-4">
                    ...
                    <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
                        I'm a second-year Computer Science & Engineering student with a passion for coding and gaming. I love exploring new technologies and building projects that challenge my skills. 
                    </p>
